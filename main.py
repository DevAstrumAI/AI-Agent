...
# ─────────────────────────────────────────────
# Book appointment endpoint (called by agent)
# ─────────────────────────────────────────────
...
def create_booking(req: BookingRequest):
    """
    Called by the LiveKit voice agent to save a confirmed booking.
    Marks the slot as booked and inserts an appointment record.
    Both the agent and admin dashboard share this same database.
    """
    from database.db import book_appointment
